							...
							<TrackVisibility>
								{({ isVisible }: { isVisible: boolean }) => (
									<div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
										...
										<p>
											I am a motivated programmer who enjoys taking on difficult challenges and improving my skills in any facet
											of life. I have a degree in Computer Science from Dawson College and a Diploma in Full-Stack Web
											Development from Concordia University. I cam write clear and concise code and I love to solve complex
											algorithms.
										</p>
